...
Let's take a look at this with [band_practice](https://github.com/Ada-Developers-Academy/band_practice) demo app. From the command line, we'll use *curl* to fetch the `#show` action for the Singles controller:
